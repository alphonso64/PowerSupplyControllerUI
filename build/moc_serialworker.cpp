...
void SerialWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->errorDispatch((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SerialWorker::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialWorker::errorDispatch)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SerialWorker::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SerialWorker.data,
...
// SIGNAL 0
void SerialWorker::errorDispatch(int _t1)
{
